...
sentence_translation: 'The two bodies of water are not alike: one is fresh, palatable,
  ...
  their way through both, so you may seek His bounty and give thanks ˹to Him˺.'
word_by_word:
  1:
    arabic: وَمَا
    translation: And not
...
And the two seas (kinds of water) are not alike: this is palatable, sweet and pleasant to drink, and that is salty and bitter. In the next verse: وَمِن كُلٍّ تَأْكُلُونَ لَحْمًا طَرِ‌يًّا وَتَسْتَخْرِ‌جُونَ حِلْيَةً تَلْبَسُونَهَا (And from each, you eat fresh meat, and derive ornaments that you wear - 35:12), it is being said that one gets fresh meat, that is, fish to eat from both waters, sweet or brackish.

## Tafsir Ibn Kathir

And the two seas (kinds of water) are not alike: this is palatable, sweet and pleasant to drink, and that is salty and bitter. And from them both you eat fresh tender meat (fish), and derive the ornaments that you wear. And you see the ships cleaving, that you may seek of His bounty, and that you may give thanks (12)
...
(and that is salty and bitter.) Then Allah says:
...
يَخْرُجُ مِنْهُمَا اللُّؤْلُؤُ وَالْمَرْجَانُ - فَبِأَيِّ آلَاءِ رَبِّكُمَا تُكَذِّبَانِ
