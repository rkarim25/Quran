...
لِكُلٍّ جَعَلْنَا مِنكُمْ شِرْعَةً وَمِنْهَاجًا وَلَوْ شَاءَ اللَّهُ لَجَعَلَكُمْ أُمَّةً وَاحِدَةً وَلَٰكِن لِّيَبْلُوَكُمْ فِي مَا آتَاكُمْ فَاسْتَبِقُوا الْخَيْرَاتِ إِلَى اللَّهِ مَرْجِعُكُمْ جَمِيعًا
...
أَيْنَ مَا تَكُونُوا يَأْتِ بِكُمُ اللَّهُ جَمِيعًا إِنَّ اللَّهَ عَلَىٰ كُلِّ شَيْءٍ قَدِيرٌ
...
**Essence** Every community has its own direction of worship, so rather than quarrel over it, race one another toward good deeds — for Allah will gather you all, and He has power over everything.

**What it teaches** The verse opens with "Wijhah," which lexically means the thing one turns one's face toward; the Companion Ibn 'Abbas glossed it as Qiblah, religious orientation, and the Companion Ubayy ibn Ka'b read the word here outright as "Qiblatun," leaving the meaning unambiguous. The commentators observe that every traditional community has had a direction of its own — whether appointed by Allah or chosen for itself — while only Allah's appointed Qiblah is the true one. On that basis the ayah turns the believer away from disputing about orientation toward "fastabiqu al-khayrat," striving to outstrip one another in good, since all return to Allah for judgment.

**The scholars** Ibn Kathir relates from Al-'Awfi that Ibn 'Abbas read this as referring to the followers of the various religions: every nation and tribe chooses its own Qiblah, while Allah's appointed Qiblah is what the believers face. Abul-'Aliyah said the Jew has a direction and the Christian has a direction, but Allah has guided this Ummah to the true Qiblah — a view also carried from Mujahid, 'Ata', Ad-Dahhak, Ar-Rabi' bin Anas and As-Suddi. Ibn Kathir explains "Wherever you are, Allah will bring you together" as His power to gather mankind on the Day of Resurrection even after bodies have disintegrated and scattered. Maarif ul Quran (drawing on Al-Qurtubi) adds that since the People of the Book will not abandon their orientation and are not expected to listen to reason, Allah tells the Muslims not to waste themselves in fruitless disputes but to prepare for death and the Hereafter; the anxiety to win arguments betrays attachment to the temporal world, whereas wisdom lies in caring for what is everlasting. Maarif further notes that "strive to excel" means hastening to a good deed the moment the opportunity comes — for the ability to do good is itself a favour from Allah, and to neglect it is ingratitude that may be punished by withdrawal of that ability. The Fuqaha therefore took from this verse the established principle that a prescribed prayer must not be delayed past its time without a valid excuse.

**From the Sunnah** Striving to excel does not mean every prayer must be rushed to its earliest moment; where the Prophet ﷺ indicated otherwise, a prayer may rightly be offered later within its time. Maarif cites that Al-Bukhari reports from Anas the superior merit of offering the Isha prayer rather late in the night — and notes (via Al-Qurtubi) that Abu Hurayrah likewise reports such a preference on the part of the Prophet ﷺ himself. (Al-Bukhari) And Al-Bukhari and Al-Tirmidhi report from Abu Dharr that on a journey, when Bilal wished to call the adhan for Zuhr as its time entered, the Prophet ﷺ told him to wait until it was cooler, saying the heat of the noon-day is part of the fire of Hell. (Al-Bukhari and Al-Tirmidhi)

**Reflection** Disputes over forms and labels are a quiet theft of the energy the Hereafter is owed; the one anxious to win every argument is still bound to this passing world. Turn that same strength to outrunning others in good — and because the very chance to do good is a trust that can be withdrawn, take it the moment Allah opens its door.
