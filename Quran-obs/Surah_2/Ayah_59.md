...
This verse is a continuation of the preceding verse. Allah had commanded the Israelites to keep, while entering the city, repeating the word Hittatun حِطَّةٌ (which indicates repentance for one's sin and the request for pardon). But they replaced this word with another phrase by way of mockery, and started saying, Habbatun fi sha` irah (grain in the midst of barley), or Hintatun حِطَّةٌ (wheat).
