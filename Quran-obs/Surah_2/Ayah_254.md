...
O believers — spend from what We provided before a Day comes when there will be no bargaining, friendship, or intercession. Those who reject the truth are the wrongdoers.

## AI Tafsir

**Essence** Spend in Allah's cause now, while you still can, for a Day is coming when no ransom, no friendship, and no intercession will redeem a soul that met Allah rejecting Him.

**What it teaches** Allah calls the believers to spend (anfiqu) from the provision (rizq) He Himself granted them, so the reward is stored with their Lord before the Day of Resurrection arrives — a Day with no bayʿ (bargaining or ransom), no khullah (friendship or kinship that rescues), and no shafaʿah (intercession) to avail the one who comes as a disbeliever. The verse seals its warning by naming the kafirun (those who reject the truth) as the very wrongdoers (zalimun), for no wrong is graver than meeting Allah in disbelief.

**The scholars** Ibn Kathir explains that Allah commands His servants to spend for His sake, in the path of righteousness, from what He has granted them, so that they acquire and keep the reward of this righteous deed with their Lord and King — and to rush to it in this life. On that Day, he says, no one can bargain on his own behalf or ransom himself with any amount, even the earth's fill of gold, nor will friendship or relation benefit him; he cross-references "there will be no kinship among them that Day" (23:101). On "nor intercession," Ibn Kathir clarifies the meaning is that they — the disbelievers — will not benefit by anyone's intercession; the negation is bound to those who reject the truth, not a denial of the intercession Allah permits for the people of tawhid. The phrase "the disbelievers are the wrongdoers," he notes, shows no injustice is worse than meeting Allah as a disbeliever; he records ʿAta' bin Dinar's gratitude that Allah said "the disbelievers are the wrongdoers" and not "the wrongdoers are the disbelievers" — for many a wrongdoer is not a disbeliever. Maarif ul Quran observes that spending one's life and possessions is the hardest act, and that love of these two is the root of sin; this is why, after the call to fight in Allah's way (244) and the call to lend Allah a goodly loan (245), the theme of spending is renewed here. Its summary captures the warning: the time to act is still here, for in the Hereafter deeds cannot be acquired, cannot be borrowed from a friend, and once the punishment seizes a person none can win his release by intercession unless Allah Himself forgives.

**Reflection** What you send ahead with open hands today is the only wealth that will still be yours when wealth itself no longer answers the call.
