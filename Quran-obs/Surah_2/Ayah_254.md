...
**What this ayah teaches:** Spend of that with which We have provided for you, before a Day comes when there will be no bargaining, nor friendship, nor intercession. Therefore, the sections that follow have, in most of them, a discussion of the second aspect, which is, the 'spending' out of one's possessions.

**Classical tafsir:** Ibn Kathir notes: Allah commands His servants to spend for His sake, in the path of righteousness, from what He has granted them, so that they acquire and keep the reward of this righteous deed with their Lord and King.
