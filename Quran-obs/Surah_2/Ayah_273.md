...
sentence_translation: ˹Charity is˺ for the needy who are too engaged in the cause
  ...
  them by their appearance. They do not beg people persistently. Whatever you give
  in charity is certainly well known to Allah.
word_by_word:
  1:
...
(7). Verse 273: لِلْفُقَرَ‌اءِ الَّذِينَ أُحْصِرُ‌وا فِي سَبِيلِ اللَّـهِ (الی قولہ) فَإِنَّ اللَّـهَ بِهِ عَلِيمٌ"For the
...
يَحْسَبُهُمُ الْجَاهِلُ أَغْنِيَاءَ مِنَ التَّعَفُّفِ : "An ignorant person takes them to be rich on account of their abstinence."
...
لَا يَسْأَلُونَ النَّاسَ إِلْحَافًا :"They do not beg people importunately."
