...
sentence_translation: Righteousness is not in turning your faces towards the east
  ...
  wealth to relatives, orphans, the poor, ˹needy˺ travellers, beggars, and for freeing
  captives; who establish prayer, pay alms-tax, and keep the pledges they make; and
  who are patient in times of suffering, adversity, and in ˹the heat of˺ battle. It
...
**Essence** Righteousness is not an empty gesture of direction but a living whole — true faith, generous giving, faithful worship, kept covenants, and patience under trial.

**What it teaches** Allah declares that birr — goodness in its absolute, all-encompassing sense, combining every inward and outward act of obedience — is not reducible to merely turning your face east or west. The verse then unfolds birr across three orders of religion: the articles of faith (believing in Allah, the Last Day, the angels, the Books and the prophets), the deeds that follow from them (spending wealth, prayer, almsgiving, keeping pledges), and the inner moral life (steadfast patience). Those who embody all of this, the verse concludes, are the truthful (alladhina sadaqu) and the people of taqwa.

**The scholars** Ibn Kathir explains the setting: Allah had first commanded facing Bayt al-Maqdis, then the Ka'bah, and this shift troubled some People of the Book and even some Muslims; the verse clarifies that the goal is obedience to whatever Allah legislates — "facing the east or the west does not necessitate righteousness or obedience unless it is legislated by Allah" — just as He said of sacrifices, "It is neither their meat nor their blood that reaches Allah, but it is the piety from you" (22:37). Abu al-'Aliyah notes the Jews faced west and the Christians east for their qiblah, so the verse turns attention from direction to true faith "whose essence requires implementation"; Ath-Thawri read "but birr is the one who believes in Allah" and said what follows are the very types of birr. Ibn Kathir adds that "in spite of love for it" means giving while still desiring wealth (cf. 3:92, "By no means shall you attain Birr unless you spend of that which you love"), that kinsfolk have the first right to charity, that the true poor (miskin) may be the one who is overlooked, and that "the time of fighting" means standing firm on the battlefield. Maarif ul Quran frames the whole verse as the gateway to the chapters of birr: it gathers the three great departments of religion — articles of faith, deeds (worship and dealings with people), and morals — and notes that "in spite of its love" may mean giving for Allah's sake, giving what one truly loves, or giving with a contented heart (Imam al-Jassas held all three may be intended). Maarif also observes that listing other spending before zakah proves financial duties do not end with zakah, and that patience (sabr) alone represents all inner deeds because it is "to control the human self and guard it against evil."

**Reflection** Measure your faith not by outward forms alone, but by what your wealth, your worship, your word, and your patience reveal when they are tested.
