...
word_by_word:
  ...
  3:
    arabic: خَدَّكَ
    translation: your cheek
    transliteration: khaddaka
  4:
    arabic: لِلنَّاسِ
...
In verse 18, it was said: وَلَا تُصَعِّرْ‌ خَدَّكَ لِلنَّاسِ (And do not turn your cheek away from people). The expression: لَا تُصَعِّرْ‌ (la tusa"ir) is a derivation from: صَعَرَ (sa’ ara) which is a disease among camels that causes a tilt in the neck similar to the stroke among human beings that makes the face become crooked. It carries the sense of turning one's face away (in disdain). Thus, the verse means: 'do not turn your face away from people when you meet them and talk to them for it is a sign of avoidance and arrogance and very much against the norms of gentle manners.'
