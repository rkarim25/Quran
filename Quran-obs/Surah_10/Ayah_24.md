...
sentence_translation: The life of this world is just like rain We send down from the
  ...
  control over it, there comes to it Our command by night or by day, so We mow it
  down as if it never flourished yesterday! This is how We make the signs clear for
  people who reflect.
word_by_word:
  1:
    arabic: إِنَّمَا
