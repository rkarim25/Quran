...
sentence_translation: And so We awakened them so that they might question one another.
  ...
  city, and let him find which food is the purest, and then bring you provisions from
...
word_by_word:
  ...
  34:
    arabic: وَلۡيَتَلَطَّفۡ
    translation: and let him be cautious
    transliteration: walyatalaṭṭaf
  35:
    arabic: وَلَا
    translation: And let not be aware
    transliteration: walā
  36:
    arabic: يُشۡعِرَنَّ
    translation: And let not be aware
    transliteration: yush'ʿiranna
  37:
    arabic: بِكُمۡ
...
To understand **The Cave** (Al-Kahf) 19, we need to step into the world of the Prophet ﷺ and ask the questions Yasir Qadhi often begins with: *what was happening, when was this revealed, and why did Allah choose this moment?*
