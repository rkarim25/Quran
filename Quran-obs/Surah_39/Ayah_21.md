...
Later in verse 21, it was said: مُّخْتَلِفًا أَلْوَانُهُ (the crops of different colours). At the time the crops grow and ripen, colors keep changing from one to the other. Since these colors change, therefore, the word: مُّخْتَلِفًا (mukhtalifan), in terms of its grammatical analysis, has been used in the form of: حَال (ha state, circumstantial condition) which denotes change.
