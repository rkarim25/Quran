...
Who sees you when you rise for salah — the formal prayer at night,

## AI Tafsir

**Context:** ` Ashirah'o, عَشِيرَ‌ۃ means clan and by limiting it with 'aqrabin (the nearest people) it is used for close relatives.

**What this ayah teaches:** It is an everyday experience that in order to follow good conduct and morals and then to stick to them is only possible when the environment is favourable for that.
