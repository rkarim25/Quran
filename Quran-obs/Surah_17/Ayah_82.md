...
word_by_word:
  1:
    arabic: وَنُنَزِّلُ
    translation: And We reveal
    transliteration: wanunazzilu
  2:
    arabic: مِنَ
    translation: from
...
And We send down of the Qur'an that which is a cure and a mercy to the believers, and it increases the wrongdoers in nothing but loss (82)
