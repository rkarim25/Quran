...
word_by_word:
  ...
  25:
    arabic: يُعَذِّبۡهُ
    translation: He will punish him
    transliteration: yuʿadhib'hu
  26:
    arabic: عَذَابًا
...
يُؤْتِكُمُ اللَّهُ أَجْرًا حَسَنًا ۖ وَإِنْ تَتَوَلَّوْا كَمَا تَوَلَّيْتُمْ مِنْ قَبْلُ
...
Allah then mentions the legal reasons that allow one to be excused from joining the Jihad, such as blindness and being lame, and various illnesses that strike one and are remedied in few days. When one is ill, he is allowed to remain behind and will have a valid excuse to do so, until his illness ends. Allah the Exalted and Most honored then said, while ordaining joining the Jihad and obeying Allah and His Messenger ﷺ,

وَمَنْ يُطِعِ اللَّهَ وَرَسُولَهُ يُدْخِلْهُ جَنَّاتٍ تَجْرِي مِنْ تَحْتِهَا الْأَنْهَارُ ۖ وَمَنْ يَتَوَلَّ
